...
14. **プロフィール** - フォロー/アンフォロー機能、投稿一覧、プロフィール編集
15. **通知・DM** - いいね・コメント・フォロー・引用・リプライ・DM通知（リアルタイム・未読バッジ）
...
- **Google Gemini API** - AIレシピ生成・健康分析・レシートOCR・カロリー計測・買い物リスト最適化
  - `gemini-2.0-flash-exp` - レシピ生成・健康アドバイザー・買い物リスト提案
  - `gemini-2.5-flash-lite` - レシートOCR・カロリー計測 (1日1,000リクエスト)
  - **403エラー診断ツール** - 自動診断機能付きエラーハンドリング
...
- ✅ **Gemini API 403エラー診断ツール** - 自動診断機能付きエラーハンドリング
