 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d="storage";function iw(n,e,t){return n=J(n),RI(n,e,t)}function ow(n){return n=J(n),SI(n)}function aw(n,e){return n=J(n),kI(n,e)}function cw(n=To(),e){n=J(n);const r=Ls(n,$d).getImmediate({identifier:e}),s=ul("storage");return s&&DI(r,...s),r}function DI(n,e,t,r={}){NI(n,e,t,r)}function VI(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new wa(t,r,s,e,sn)}function OI(){Jt(new Pt($d,VI,"PUBLIC").setMultipleInstances(!0)),He(rl,sl,""),He(rl,sl,"esm2020")}OI();export{UI as A,FI as B,Pt as C,MI as D,BI as E,Ze as F,yt as G,ZI as H,xI as I,ew as J,LI as K,aw as L,iw as M,ow as N,nw as O,ee as T,Ls as _,WI as a,XI as b,$I as c,pT as d,tw as e,To as f,QI as g,J as h,rw as i,ul as j,Ot as k,KI as l,_o as m,Jt as n,GI as o,go as p,HI as q,He as r,YI as s,Ne as t,JI as u,qI as v,sw as w,zI as x,cw as y,Kp as z};
