 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d="storage";function iw(n,e,t){return n=J(n),RI(n,e,t)}function ow(n){return n=J(n),SI(n)}function aw(n,e){return n=J(n),kI(n,e)}function cw(n=To(),e){n=J(n);const r=Ls(n,$d).getImmediate({identifier:e}),s=ul("storage");return s&&DI(r,...s),r}function DI(n,e,t,r={}){NI(n,e,t,r)}function VI(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new wa(t,r,s,e,sn)}function OI(){Jt(new Pt($d,VI,"PUBLIC").setMultipleInstances(!0)),He(rl,sl,""),He(rl,sl,"esm2020")}OI();export{Ne as A,qI as B,Pt as C,zI as D,cw as E,Ze as F,Kp as G,UI as H,FI as I,MI as J,yt as K,BI as L,xI as M,ew as N,LI as O,ee as T,Ls as _,XI as a,QI as b,$I as c,pT as d,nw as e,tw as f,ow as g,JI as h,ZI as i,rw as j,sw as k,KI as l,To as m,J as n,GI as o,ul as p,HI as q,aw as r,YI as s,Ot as t,iw as u,go as v,WI as w,_o as x,Jt as y,He as z};
