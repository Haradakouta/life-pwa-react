  ...
  const functionCards: FunctionCard[] = useMemo(() => [
    {
      ...
      label: t('quickActions.meals'),
      color: '#3b82f6',
    },
    {
      screen: 'exercise' as Screen,
      icon: <MdTrendingUp size={32} />,
      label: t('quickActions.exercise'),
      color: '#ec4899',
    },
    {
      screen: 'barcode',
