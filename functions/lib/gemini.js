...
exports.generateShoppingListWithTrend = exports.scanCalorie = exports.generateText = exports.generateRecipe = void 0;
...
async function callGeminiApi(prompt, options = {}) {
    ...
    const requestBody = {
        ...
        generationConfig: {
            ...
            maxOutputTokens: (_b = options.maxOutputTokens) !== null && _b !== void 0 ? _b : 8192,
        },
    };
 ...
 * レシピ生成
 */
exports.generateRecipe = functions.https.onCall({ timeoutSeconds: 300, memory: '512MiB' }, async (request) => {
    var _a, _b, _c, _d, _e;
 ...
 * 汎用テキスト生成
 */
exports.generateText = functions.https.onCall({ timeoutSeconds: 300, memory: '512MiB' }, async (request) => {
    var _a, _b, _c, _d, _e;
 ...
 */
async function callGeminiApiWithImage(prompt, imageBase64, mimeType, options = {}) {
    var _a, _b;
    const apiKey = getGeminiApiKey();
    const modelName = options.model === 'pro' ? PRO_MODEL_NAME : FLASH_MODEL_NAME;
    const url = `${GEMINI_API_BASE_URL}/models/${modelName}:generateContent?key=${apiKey}`;
    const requestBody = {
        ...
        generationConfig: {
            ...
            topK: 32,
            topP: 1,
            maxOutputTokens: (_b = options.maxOutputTokens) !== null && _b !== void 0 ? _b : 1024,
        },
    };
    const response = await fetch(url, {
        method: 'POST',
 ...
 * カロリー推定（画像解析）
 */
exports.scanCalorie = functions.https.onCall({ timeoutSeconds: 300, memory: '512MiB' }, async (request) => {
    var _a, _b, _c, _d, _e;
...
`.trim();
    try {
        const result = await callGeminiApiWithImage(prompt, imageBase64, mimeType || 'image/jpeg', { temperature: 0.3, maxOutputTokens: 4096, model: 'pro' });
        const text = ((_e = (_d = (_c = (_b = (_a = result.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text) || '';
 ...
 */
exports.generateShoppingListWithTrend = functions.https.onCall({ timeoutSeconds: 60, memory: '256MiB' }, // タイムアウトとメモリを削減（API呼ばないので）
async (request) => {
    ...
    Object.entries(targetComposition).forEach(([category, count]) => {
        ...
        const candidates = INGREDIENTS_DB.filter(item => item.category === category &&
